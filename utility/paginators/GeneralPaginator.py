...
class GeneralPaginator:
    ...
    async def start(self, embeded: Optional[bool] = False, quick_navigation: bool = True, edit_original_response: bool = False, follow_up: bool = False, materials: bool = False) -> None:
        if not (self.pages):
